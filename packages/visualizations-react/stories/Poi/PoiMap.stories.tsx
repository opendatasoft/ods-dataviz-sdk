    ...
    options: {
        ...
        legend: {
            ...
            items: [
                ...
                { label: 'catégorie 4', color: '#FFD580', borderColor: 'orange', variant: 'circle' as const },
                { label: 'catégorie 5', color: '#CBC3E3', borderColor: 'purple', variant: 'circle' as const },
                { label: 'catégorie 6', color: 'yellow', borderColor: '#fdd835', variant: 'circle' as const },
            ],
