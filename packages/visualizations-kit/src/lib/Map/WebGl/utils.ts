...
import { isGroupByForMatchExpression } from '$lib/types';
...
const getMapCircleLayer = (layer: CircleLayer): CircleLayerSpecification => {
	...
	let circleColor: ExpressionSpecification | string = layerColor;
	let circleBorderColor: ExpressionSpecification | string | undefined = layerBorderColor;
